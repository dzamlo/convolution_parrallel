...
int main(void) {
    ...
    if(threads == 0) {
        convolve(img_input, img_output, KERNEL_EDGE, 0, 0, img_input->width*img_input->height);  
         ...
         convolve_params_t arg_t1 = {img_input, img_output, KERNEL_EDGE, 0, 0, 242688};
         convolve_params_t arg_t2 = {img_input, img_output, KERNEL_EDGE, 0, 237, 242688};
         convolve_params_t arg_t3 = {img_input, img_output, KERNEL_EDGE, 0, 474, 242688};
         pthread_t t1, t2, t3;
